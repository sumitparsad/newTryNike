...
const KidsProducts = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5001/products/kids")
      .then((response) => {
        setProducts(response.data.products);
      })
      .catch((error) => {
        console.error("There was an error fetching the kids' products!", error);
      });
  ...
  return (
    <div>
      <h1 className="font-Anton text-6xl font-semibold p-12">Kids' Products</h1>
